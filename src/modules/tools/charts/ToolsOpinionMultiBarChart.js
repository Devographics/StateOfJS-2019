    ...
    return (
        <div
            style={{
                ...
                margin: '6px 0',
                display: 'grid',
                gridTemplateColumns: '24px auto 1fr auto 24px',
                gridColumnGap: 12,
                alignItems: 'center'
            }}
        >
...
const ToolsOpinionMultiBarChart = ({ data }) => {
...
ToolsOpinionMultiBarChart.propTypes = {
    data: PropTypes.array.isRequired
}

export default memo(ToolsOpinionMultiBarChart)
