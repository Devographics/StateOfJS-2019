...
import { colors, getColor } from '../../constants.js'

const Logo = ({ width = '100%' }) => (
    <svg width={width} viewBox="0 0 492 296" fill="none" xmlns="http://www.w3.org/2000/svg">
        <Cell px={0} py={0} text="St" color={colors.grey} />
        <Cell px={1} py={0} text="At" color={colors.grey} />
        <Cell px={2} py={0} text="E" color={colors.grey} />
        <Cell px={4} py={0} text="Of" color={getColor('activeColor')} />
